...
export const PERMISSION_MATRIX: Array<{ permission: Permission; label: string; note?: string }> = [
  ...
  { permission: 'view:user_detail', label: 'Individual user raw detail', note: 'Withheld from Admin by design' },
  ...
  { permission: 'view:usage_behavior', label: 'Usage-behaviour analytics', note: 'Withheld from Billing' },
